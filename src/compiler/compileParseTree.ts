...
import {currentlyExecutedLine, registers, memory} from "@stores"
...
import type {iCompiledInstruction, iCompiledOperand, iError, iInstruction, iOperand, iRow, tSegment, tTokenBits} from "@compiler/types";
